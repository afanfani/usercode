...
with potentially as many as 3000 users. This represents an unprecedent scale of
...
The beams will collide at an interval of 25 ns and CMS will record only the collisions
...
in order to allow access to other collegues.
...
on a list of associated Tier2s was set up. 
...
Analysis specific operations to improve the success rate and user experience when utilizing the distributed computing environment and to ensure a functional system with a more efficient use of CMS resources on sustained user activities are being set up.
