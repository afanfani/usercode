...
\begin{minipage}{.45\textwidth}
\centering
\includegraphics[width=1.\textwidth]{figures/UserInteg.png}
\caption{Cumulative number of distinct CRAB users starting from 2008. }
\label{fig:intuser}
\end{minipage}
\begin{minipage}{.45\textwidth}
\centering
\includegraphics[width=1.\textwidth]{figures/crabusersdaily.png}
...
\begin{minipage}{.45\textwidth}
\centering
\includegraphics[width=1.\textwidth]{figures/CRAFTusers.pdf}
...
\begin{minipage}{.45\textwidth}
\centering
\includegraphics[width=1.\textwidth]{figures/CRAFTjobs.pdf}
