...
\label{sec:4_3_2}
Physicist are organized in Physics Groups each with its own internal organization.
Each Physics Groups is associated with a few Tier-2 sites that support it by providing storage space and processing power.
...
\subsubsection{Pubblication of Physics Group and User data}
TO BE ADDED. AS A SEPARATE SUBSECTION OR INCLUDED IN THE ABOVE?
...
\item{} Centrally Controlled Space: 30TB (growing to 50TB in 2009) of space is identified at each Tier-2 under the control of CMS centrally.
...
The distribution of jobs at Tier2s over the year is shown in Figure~\ref{fig:AnalysisJobHistoryApril0809}. Current analysis activities has spontaneously surpassed, in term of number of jobs and number of sites, the scale reached in CCRC08 dedicated tests. 
...
The distribution of analysis job efficiency over time is shown inFig.~\ref{fig:T2EffApril0809}.
