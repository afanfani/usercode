...
metrics to highllite overall patterns and trends (see Fig.~\ref{fig:HistoryView}).
\begin{figure}
...
\label{sec:4_1}
The tools described in previous section operate on a distributed infrastructure
of sites which offer uniform access for
CMS needs via standard Grid services, moreover CMS maintains
...
%% From DanieleB
NEEDS SOME WORK: CHECK 2008 DATE, ADD SOMETHING ABOUT
ONGOING EFFORT MORE THEN HISTORY, COMMISSIONED LINKS OVERVIEW
MEANS NOTHING ETC>
...
which can nto be hosted at T2's.
