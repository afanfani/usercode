...
\label{sec:3_1_2}
CMS application only knows about logical files and relies on a local catalogue service to have access to the physical files.
Each CMS site has a Trivial File Catalogue made of simple rules to build site-specific physical paths from logical file names and access protocols.
...
\emph{one/two lines of introduction....mention MC production then analysis}
\label{sec:3_2}
\subsubsection{CRAB}
...
\label{sec:4_2_2}
\paragraph{Association T2-Physics group}
