...
%             \emph{Present address:} of F. Author  %  if needed
           ...
           \and
           G. Bagliesi \and S. Sarkar \at Pisa INFN, Italy
           \and
           F. Farina \at Milano Bicocca INFN, Italy
           \and
           M. Cinquilli \at Perugia INFN, Italy
           \and
           S. Metson \at Bristol University, UK
           \and
           D. Colling \at Imperial College, London, UK
           \and
           C. Brew \at RAL, UK
           \and
           T. Kress \and C. Wissing \and P. Kreuzer \at Germany....
           \and
           J. D'Hondt \and J. Klem \and G. Maier \and J.Maes \and P. Van Mulders \and I. Villella \at Belgium....
           \and
           ...
           \and
           K. Bloom \at Nebraska University, USA
}
...
%add motivations to choose a distributed environment: leverage facility infrastructure, access to additional funding channels, empower local CMS communities 
...
\label{sec:3}
%The Workload and Data Management Systems have been designed following the philosophy of using existing Grid Services as much as possible, building on top of them CMS-specific services. 
...
% FIXME: fill phedex usage numbers
...
%The produced output is either returned to the user, for small files, or copied to a Tier-2 the user is associated with.
...
\end{itemize} 
%CRAB is implemented in python as a batch-like command line application and is distributed as a compressed archive (tgz). 
...
%explicitly mention the stageout and publication of users data
...
G. Codispoti et al. .....to be published in TNS
%% Format for books
%\bibitem{RefB}
