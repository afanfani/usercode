...
private: 
  ...
  // select events suitable for magnetic field studies - they have a track in the tracker
   bool doBFieldStudySelection(edm::Handle<reco::TrackCollection> saTracks, edm::Handle<reco::TrackCollection> Tracks, edm::Handle<reco::TrackCollection> gMuons);

  // select events suitable for magnetic field studies - global muons
   bool doOctoberExeSelection(edm::Handle<reco::TrackCollection> gMuons);
